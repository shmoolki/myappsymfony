...
*/
	...
	?>
		...
		<?php
		if (($user->util_admin()==1) &&($maPage=="adminUser" || $maPage=="horaire"|| $maPage=="parametrage" || $maPage=="admin" || $maPage=="CA")){
		?>
          <li <?php 
		 if (!isset($maPage)){}elseif ($maPage=="admin"){echo 'class="active"';}	
		?>><a href="v2/web/app_dev.php/prime/hello/<?php echo $user->util_id(); ?>">Admin V2 </a><a href="admin.php?util=<?php echo $user->util_id(); ?>">Admin </a></li>
		<?php ?>
          <li <?php 
		...
		?>><a href="param.php?util=<?php echo $user->util_id(); ?>">Parametrage (en cours)</a></li>
		  <li <?php 
